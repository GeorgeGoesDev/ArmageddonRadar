      ...
      <View className="flex-1 justify-end" style={{ backgroundColor: 'rgba(0,0,0,0.6)' }}>
        <View className="rounded-t-3xl" style={{ backgroundColor: colors.spaceBlack, borderTopWidth: 1, borderColor: colors.cardBorder, height: '90%' }}>
          ...
          <ScrollView className="px-5" style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: 32 }}>
            ...
            <Pressable onPress={() => Linking.openURL(KOFI_URL).catch(() => {})} className="mt-2 flex-row items-center">
              <MaterialCommunityIcons name="coffee" size={16} color={colors.accentBlue} />
              <Text className="text-sm ml-2" style={{ color: colors.accentBlue }}>{t('settings.supportDev')}</Text>
            </Pressable>
          </ScrollView>
          </SafeAreaView>
        </View>
